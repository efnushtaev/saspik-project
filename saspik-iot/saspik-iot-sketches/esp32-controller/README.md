...
#### ESP32-шлюз: сбор данных от узлов по ESP-NOW, публикация в MQTT кластера SASPIK

Шлюз собирает данные от узлов по ESP-NOW, парсит бинарный протокол с CRC8
и публикует JSON в MQTT кластера SASPIK.
Подписывается на relay-топики для управления нагрузками.
...
Все настройки в [`src/config.h`](../esp32-controller/src/config.h):
- WiFi SSID / пароль
