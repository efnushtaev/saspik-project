...
#### Прошивка для ESP32 с датчиками DHT-22 и поплавковым датчиком (геркон)

Данные отправляются по ESP-NOW на приёмник.
...
Все настройки в [`src/config.h`](../saspik-iot-node-sensor-1/src/config.h):
